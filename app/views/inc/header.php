...
<head>
    ...
    <title><?php echo $_ENV['SITENAME'] ?></title>
    <link rel="stylesheet" href="<?php echo $_ENV['URLROOT']; ?>/css/reset.css">
    </link>
    <link rel="stylesheet" href="<?php echo $_ENV['URLROOT']; ?>/css/normalize.css">
    </link>
    <link rel="stylesheet" href="<?php echo $_ENV['URLROOT']; ?>/css/style.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $_ENV['URLROOT']; ?>/slick/slick.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $_ENV['URLROOT']; ?>/slick/slick-theme.css" />
    </link>
</head>
        ...
        <div class="flex-container">
            ...
            <div class="menu_right">
                ...
                <div class="auth-button">
                    <a href="login_or_register_page.html">
